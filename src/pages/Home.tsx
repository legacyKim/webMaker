  ...
  lg: [
    {
      ...
      h: 8,
      explain:
        "김태훈의 포트폴리오입니다. 레이아웃에서 우클릭을 하면 링크로 이동할 수 있는 툴팁이 열립니다.",
    ...
    },
    {
      ...
      h: 8,
      explain:
        "평소에 책을 읽고 메모를 하거나 생각을 정리하는 습관이 있습니다. 그런데 메모의 양이 방대해지다 보니 찾는데 시간이 꽤 오래 걸리고 잊어버리는 경우도 허다했습니다. 이를 방지하고자 메모 정리 및 참조점에 쉽게 접근할 수 있는 기능 등을 구현하였습니다.",
    ...
    >
      ...
      >
        {layouts.lg.map((el) => (
          <div
            key={el.i}
            className={`box ${isFirstRender ? "" : "active"}`}
            onContextMenu={(e) => {
              e.preventDefault();
              e.stopPropagation();
              setLinkPopup(el);
          ...
          >
            <div className="box_inner">
              ...
              <p className="explain">{el.explain}</p>
